                  ...
                  {printJobs.map(job => (
                    <tr key={job.id} className={`border-b border-stone-100 last:border-0 transition-colors ${selectedJobs.includes(job.id) ? 'bg-stone-50' : ''}`}>
                      ...
                      <td className="py-4 text-stone-500">
                        {job.notes && <div className="text-xs truncate max-w-[150px]" title={job.notes}>{job.notes}</div>}
                      </td>
                      <td className="py-4">
                        <select
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-200 lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-semibold flex items-center text-stone-900">
              <DatabaseIcon className="mr-3 text-stone-400" />
              Makerspace Document Storage
            </h2>
          </div>
